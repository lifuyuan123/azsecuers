package com.androidy.azsecuer.activity.View;
...
public class CustomProc extends View {
    ...
    public CustomProc(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // 属性的设置
        roundColor = array.getColor(R.styleable.CustomProc_roundColor,context.getResources().getColor(R.color.white));
        roundProgressColor = array.getColor(R.styleable.CustomProc_roundProgressColor,Color.YELLOW);
            ...
            public void run() {
                switch (state){
                    case 0:
                        ...
                        if(getProgress()<10&&getProgress()>0) {
                            setProgress(getProgress() - 1);
                        }
                        if(getProgress()>10) {
                    ...
                    case 1:
                        ...
                        if(getProgress()>=0&&getProgress()<targetProgress-10){
                            setProgress(getProgress()+10);
                        }
                        if(getProgress()>=targetProgress-10){
                            setProgress(getProgress()+1);
                        }
                            if(getProgress()==targetProgress){
                                this.cancel();
