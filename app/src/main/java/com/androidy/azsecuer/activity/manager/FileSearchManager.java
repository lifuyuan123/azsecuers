...
public class FileSearchManager {
	/** 所有文件分类集合 */
	private HashMap<String, ArrayList<Filllist>> fileInfos;
	/** 所有文件大小集合 */
	...
	private void initDataList() {
		totalSize = 0;
		isStopSearch = false;
		fileInfos = new HashMap<String, ArrayList<Filllist>>();
		fileSizes = new HashMap<String, Long>();
		fileInfos.clear();
		fileInfos.put(FileSearchTypeEvent.TYPE_OTHER, new ArrayList<Filllist>());
		fileInfos.put(FileSearchTypeEvent.TYPE_APK, new ArrayList<Filllist>());
		fileInfos.put(FileSearchTypeEvent.TYPE_AUDIO, new ArrayList<Filllist>());
		fileInfos.put(FileSearchTypeEvent.TYPE_IMAGE, new ArrayList<Filllist>());
		fileInfos.put(FileSearchTypeEvent.TYPE_TXT, new ArrayList<Filllist>());
		fileInfos.put(FileSearchTypeEvent.TYPE_VIDEO, new ArrayList<Filllist>());
		fileInfos.put(FileSearchTypeEvent.TYPE_ZIP, new ArrayList<Filllist>());
		fileSizes.clear();
	...
	public HashMap<String, ArrayList<Filllist>> getFileInfos() {
		return fileInfos;
	}
	...
	private void addFileToList(File file, int romType) {
		...
		Filllist fileInfo = new Filllist(file, romType, fileType, iconName, openType);
		// 将此文件添加到对应分类集合中
